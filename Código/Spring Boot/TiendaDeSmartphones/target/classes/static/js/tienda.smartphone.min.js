...
var opciones = function () {
    return '<td>' +
        '<button type="button" class="btn btn-primary glyphicon glyphicon glyphicon-shopping-cart" data-toggle="tooltip" data-placement="top" title="Vender"></button> ' +
        '<button type="button" class="btn btn-success glyphicon glyphicon-edit" data-toggle="tooltip" data-placement="top" title="Editar"></button> ' +
